...
export const Footer = () => {
  return (
    <div className="flex flex-col gap-8 items-center justify-center pb-16 pt-28 px-5 sm:px-20 max-w-[1800px] mx-auto font-montserrat">
      <div>
        <h2 className="text-3xl font-fredoka tracking-wide text-center font-medium">
          STURMAYR
        </h2>
      </div>
